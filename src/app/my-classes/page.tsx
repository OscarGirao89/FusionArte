...
import { Calendar, Clock, MapPin, Users, BookCheck, Eye } from 'lucide-react';
...
export default function MyClassesPage() {
  ...
  const myClasses = useMemo(() => {
    ...
    return danceClasses.filter(c => c.teacherIds.includes(currentUserId));
  }, [currentUserId]);
                                    ...
                                    <div className="flex gap-2 flex-shrink-0">
                                         ...
                                         <TooltipProvider>
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <div className="w-full">
                                                        <Button variant="secondary" size="sm" disabled={!canTakeAttendance} onClick={() => router.push(`/my-classes/${c.id}/attendance`)}>
