...
import { Calendar, Clock, MapPin, Users, BookCheck, Eye, DollarSign, CheckCircle } from 'lucide-react';
    ...
    <div className="p-4 md:p-8">
      <div className="flex items-center justify-between mb-8 flex-wrap gap-2">
        ...
        <Tabs defaultValue="classes" className="w-full">
            <TabsList className="grid w-full grid-cols-2 md:grid-cols-3 lg:w-fit">
                <TabsTrigger value="classes">Mis Clases</TabsTrigger>
                <TabsTrigger value="finances">Mis Finanzas</TabsTrigger>
            </TabsList>
            
            <TabsContent value="classes" className="grid gap-6 mt-6">
                <Card>
                    <CardHeader>
            ...
            <TabsContent value="finances" className="mt-6">
              <TeacherPayroll mode="teacher_income" teacherId={currentUserId} />
            </TabsContent>
        </Tabs>
    </div>
  );
